...
tokens = [
    ...
    'GREATERTHAN',
      'COLON',  # Add GREATERTHAN token for '>'
    'EQUALS',  # Add EQUALS token for '=='
]+list(cpp_keywords.values())
...
def p_for_loop(p):
    '''
    for_loop : FOR LPAREN expression SEMICOLON expression SEMICOLON expression RPAREN LBRACE program RBRACE
    '''
    pass
